...
const Footer:FC<Footerprops>=({color,navigationprops,PlusClicked}:Footerprops)=>{
    ...
    return(
      ...
      <View style={{flexDirection:'row'}}>
        <TouchableOpacity onPress={()=>{navigationprops.navigation.navigate('Enquiry')}}>
      ...
      <View style={{height:100,width:100,backgroundColor:color,position:'absolute',left:'38%',top:550,borderRadius:150,}}/>
